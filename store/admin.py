...
from .models import Book, Book_Image, Book_Inventory, Book_Price, Cart, CartItem, Order, OrderItem


class BookAdmin(admin.ModelAdmin):
    list_display = ('title', 'auth', 'category', 'country', 'year_publish')
...
class BookPriceAdmin(admin.ModelAdmin):
    list_display = ('book', 'price')

class BookImageAdmin(admin.ModelAdmin):
    list_display = ('book', 'path')
    list_display_links = ('book',)   # Các trường có gắn link dẫn đến trang detail
    # Bắt buộc phải khai báo
    filter_horizontal = ()
    list_filter = ()
    fieldsets = ()
class BookInventoryAdmin(admin.ModelAdmin):
    list_display = ('book', 'quantity','created_at','updated_at')
    list_display_links = ('book',)   # Các trường có gắn link dẫn đến trang detail
    # Bắt buộc phải khai báo
    filter_horizontal = ()
    list_filter = ()
...
admin.site.register(Book_Price,BookPriceAdmin)
